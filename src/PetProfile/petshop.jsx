...
const PetShop = () => {
  ...
  const petProducts = [
    ...
    { id: 4, name: "Cozy Pet Bed - Memory Foam", category: "Pet Houses", rating: 4.7, reviewCount: 70, price: 49.99, image: "https://images.unsplash.com/photo-1645077133125-309814cf423a?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
